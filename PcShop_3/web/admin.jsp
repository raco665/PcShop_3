...
<div align="center">
    <button type="button"><span lang="en-us"><a href="addProdact.jsp">ADD</span></a></button>
</div>
        <div align="center">
            <h1>Products list</h1>
            <table class="tabelaProzivod" border='1' cellpadding='6' width='700'>
                ...
                <tr>
                    ...
                    <td><span lang="en-us"><a href="updateRecord.jsp">EDIT</span></a></td>
                    <td><span lang="en-us"><a href="delete.jsp">DELETE</span></a></td>
                </tr>
                <br>
                <%
